...
<body>
    ...
    <!-- product modal end -->
    <!-- hero slider start -->
    <section class="heroslider overflow-hidden">
        <div class="slider-container container-fluid p-0 position-relative shadow">
            <div class="slider" id="add-allslide">
                    <div class="slide first-slide">
                        <img src="$data[0]['slide5'];?>" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo $slide[0]['slide1']; ?>" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo $slide[0]['slide2']; ?>" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo $slide[0]['slide3']; ?>" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo $slide[0]['slide4']; ?>" alt="">
                    </div>
                    <div class="slide">
                        <img src="<?php echo $slide[0]['slide5']; ?>" alt="">
                    </div>
    ...
    <!-- hero slider ens -->
    <!-- top selling brands start-->
    <section class="top_selling_brands container-fluid my-5 Poppins">
        <div class="container position-relative">
            <h1 class="my-5 text-center  color2">Top Brands</h1>
            <div class="row justify-content-center ">
                <div class="brand-item col-md-2 col-4 m-3 p-2 border shadow">
                    <div class="brand-img">
                        <a href=""><img src="brand_images/adidas.png" alt=""></a>
                    </div>
                </div>
                <div class="brand-item col-md-2 col-4 m-3 p-2 border shadow">
                    <div class="brand-img">
                        <a href=""><img src="brand_images/axe.png" alt=""></a>
                    </div>
                </div>
                <div class="brand-item col-md-2 col-4 m-3 p-2 border shadow">
                    <div class="brand-img">
                        <a href=""><img src="brand_images/noise.png" alt=""></a>
                    </div>
                </div>
                <div class="brand-item col-md-2 col-4 m-3 p-2 border shadow">
                    <div class="brand-img">
                        <a href=""><img src="brand_images/hp.png" alt=""></a>
                    </div>
                </div>
                <div class="brand-item col-md-2 col-4 m-3 p-2 border shadow">
                    <div class="brand-img">
                        <a href=""><img src="brand_images/hrx.png" alt=""></a>
                    </div>
                </div>
                <div class="brand-item col-md-2 col-4 m-3 p-2 border shadow">
                    <div class="brand-img">
                        <a href=""><img src="brand_images/mamaearth.png" alt=""></a>
                    </div>
                </div>
                <div class="brand-item col-md-2 col-4 m-3 p-2 border shadow">
                    <div class="brand-img">
                        <a href=""><img src="brand_images/nike.png" alt=""></a>
                    </div>
                </div>
                <div class="brand-item col-md-2 col-4 m-3 p-2 border shadow">
                    <div class="brand-img">
                        <a href=""><img src="brand_images/peterengland.png" alt=""></a>
                    </div>
                </div>
                <div class="brand-item col-md-2 col-4 m-3 p-2 border shadow">
                    <div class="brand-img">
                        <a href=""><img src="brand_images/sugar.png" alt=""></a>
                    </div>
                </div>
                <div class="brand-item col-md-2 col-4 m-3 p-2 border shadow">
                    <div class="brand-img">
    ...
    <!-- best selling offer start -->
    <section class="best-selling-offer container-fluid my-5 Poppins">
        <div class="container">
            <h1 class="my-5 text-center  color2">Best Offers</h1>
            <div class="row shadow">
                <div class="offer col-3 p-0 border">
                    <div class="offer-img">
                        <a href=""><img src="offer_images/40.png" alt=""></a>
                    </div>
                </div>
                <div class="offer col-3 p-0 border">
                    <div class="offer-img">
                        <a href=""><img src="offer_images/30.png" alt=""></a>
                    </div>
                </div>
                <div class="offer col-3 p-0 border">
                    <div class="offer-img">
                        <a href=""><img src="offer_images/20.png" alt=""></a>
                    </div>
                </div>
                <div class="offer col-3 p-0 border">
                    <div class="offer-img">
                        <a href=""><img src="offer_images/10.png" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
    </section>
    <!-- best selling offer end -->
    <!-- top rating products start -->
    <section class="top_rating_products container-fluid my-5 Poppins">
        <div class="container position-relative">
            <h1 class="my-5 text-center color2">Top Products</h1>
            <div class="row justify-content-center">
                <?php 
                    $products = $obj->top_ratings();
                    foreach($products as $val){
                        $actual_price = $val['product_price']+($val['product_price']/(100-$val['discount']))*$val['discount'];
                        $img = explode("#$#",$val["product_images"]);
                        echo '<div class="product-item col-md-2 col-4 p-0 border m-3 shadow">
                ...
                <!-- <div class="product-item col-md-2 col-4 p-0 border m-3">
                    <div class="product-img">
                        <img src="product_images/boat_digital_watch.png" alt="">
                    </div>
                    <div class="product-info p-2 border-top">
